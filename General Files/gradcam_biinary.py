...
model_path = "binary_cnn.pth"
image_path = "/Users/yannisbalasis/Documents/thesis/dataset_binary_class/Testing/pituitary/Te-pi_0011.jpg"
...
def forward_hook(module, input, output):
    print("✔️ Forward hook triggered")
    activations.append(output)

def backward_hook(module, grad_input, grad_output):
    print("✔️ Backward hook triggered")
...
cam = np.power(cam, 2.0)  # Optional contrast enhancement
