...
val_dataset = BinaryLabelDataset(val_dir, transform=test_transform)
...
#  Save model
torch.save(model.state_dict(), "binary_cnn_smote.pth")
print(" Model saved as binary_cnn_smote.pth")
