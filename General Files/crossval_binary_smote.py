...
from train_binary_smote import BinaryLabelDataset
...
dataset_dir = "/Users/yannisbalasis/Documents/thesis/balanced_split"
...
train_dataset = BinaryLabelDataset(train_dir, transform=transform)
val_dataset = BinaryLabelDataset(val_dir, transform=transform)

# 🔁 Συνένωση για χρήση σε cross-validation
